...
export const Route = createFileRoute("/_authenticated/_manage/manage/teams/")({
  ...
  beforeLoad: async ({ context }) => {
    ...
    requireAnyPermission([PERMISSIONS.TEAMS_ALL], {
      permissions,
    });
...
function RouteComponent() {
  return <div>Hello "/_authenticated/_manage/manage/teams/"!</div>;
}
